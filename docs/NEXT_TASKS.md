...
## v1.8.7 Completed During Production Closure
...
- Browser video/download/cancel/retry and browser SSE terminal-close timing.
- 200/300/500-user tests remain out of scope for v1.8.7.
