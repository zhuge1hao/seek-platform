      ...
      <section className="min-w-0 rounded-xl border bg-white p-4">
        ...
        {!blueprint ? <LoadingState label="请选择蓝图..." /> : (
          <div className="space-y-4">
            ...
            {tab === "editor" ? <AgentBlueprintEditor version={version as AgentBlueprintVersion | null} readOnly={!canWrite || blueprint.status === "deprecated"} onSave={(payload) => void saveVersion(payload)} /> : null}
