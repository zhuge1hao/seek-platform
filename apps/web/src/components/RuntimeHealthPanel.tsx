...
export function RuntimeHealthPanel({ open, onClose, onChanged }: RuntimeHealthPanelProps) {
  ...
  return (
    <SafeDrawer open={open} title="后台状态" eyebrow="meizhaiseek v1.8.7" onClose={onClose} maxWidth="max-w-3xl">
        ...
        <div className="rounded-[24px] border border-slate-100 bg-slate-50 p-5">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              <p className="text-sm font-semibold text-violet-700">meizhaiseek v1.8.7</p>
